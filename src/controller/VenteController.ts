...
export default class VenteController {
    static getmyVentes = async (req: Request, res: Response) => {
    ...
    static createVente = async (req: Request, res: Response) => {
        try {
            const idUser = req.params.userId;
            const actor = await prisma.actor.findUnique({
                where: {
    ...
    static getVenteByProduit = async (req: Request, res: Response) => {
